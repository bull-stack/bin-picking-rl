...
from isaaclab.tasks.manipulation.bin_picking.bin_picking_env_cfg import BinPickingEnvCfg
from exts.isaaclab.isaaclab.assets.ur10 import UR10_CFG
from exts.isaaclab.isaaclab.tasks.manipulation.bin_picking import mdp
@configclass
